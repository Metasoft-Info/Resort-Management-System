...
<div class="relative bg-gradient-to-br from-blue-600 via-primary-600 to-purple-600 text-white py-24 overflow-hidden">
 ...
 <div class="max-w-3xl">
 <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">Convention Hall and Event Venue</h1>
 <p class="text-xl md:text-2xl text-gray-100 font-light">No Event people </p>
 </div>
 </div>
</div>
...
<section class="py-16 bg-gradient-to-b from-white to-gray-50">
 ...
 <i class="fas fa-building mr-2"></i>Exclusive Venue
 </div>
 ...
 <div class="text-sm text-gray-600 font-semibold">sq.ft</div>
 </div>
 ...
 <div class="text-sm text-gray-600 font-semibold">Guest Capacity</div>
 </div>
 ...
 <h3 class="text-2xl md:text-3xl font-bold">Amenities</h3>
 </div>
 ...
 <h3 class="text-2xl md:text-3xl font-bold">Suitable Events</h3>
 </div>
 ...
 <p class="text-gray-600 text-lg mb-4"><i class="fas fa-info-circle mr-2 text-primary-500"></i>For booking contact admin panel</p>
