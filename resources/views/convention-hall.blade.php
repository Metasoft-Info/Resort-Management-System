...
<div class="relative bg-gradient-to-br from-blue-600 via-primary-600 to-purple-600 text-white py-24 overflow-hidden">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <nav class="flex items-center text-sm mb-6">
            ...
            <span class="text-yellow-200">Convention Hall</span>
        </nav>
        <div class="max-w-3xl">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight">Convention Hall & Event Spaces</h1>
            <p class="text-xl md:text-2xl text-gray-100 font-light">Perfect venue for your memorable events</p>
        </div>
    </div>
</div>
    ...
    <div class="container mx-auto px-4">
        @foreach($halls as $hall)
            <div class="max-w-6xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden mb-12 transform hover:-translate-y-1 transition">
                <!-- Hero Image Gradient -->
                <div class="relative h-80 bg-gradient-to-br from-blue-400 via-primary-400 to-purple-500 overflow-hidden">
                    ...
                    <div class="absolute bottom-8 left-8 right-8">
                        <div class="inline-block px-4 py-2 bg-white rounded-full text-sm font-bold text-primary-700 mb-4">
                            <i class="fas fa-building mr-2"></i>Premium Venue
                        </div>
                ...
                <div class="p-8 md:p-12">
                    ...
                    <div class="grid md:grid-cols-3 gap-6 mb-12">
                        <div class="text-center p-6 bg-gradient-to-br from-blue-50 to-primary-50 rounded-2xl transform hover:-translate-y-1 transition">
                            ...
                            <div class="text-sm text-gray-600 font-semibold">Square Feet</div>
                        </div>
                        <div class="text-center p-6 bg-gradient-to-br from-purple-50 to-accent-50 rounded-2xl transform hover:-translate-y-1 transition">
                            ...
                            <div class="text-sm text-gray-600 font-semibold">Guests Capacity</div>
                        </div>
                        <div class="text-center p-6 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl transform hover:-translate-y-1 transition">
                            ...
                            <div class="text-sm text-gray-600 font-semibold">Per Day</div>
                        </div>
                    </div>
                    ...
                    <div class="mb-12">
                        <div class="flex items-center mb-6">
                            ...
                            <h3 class="text-2xl md:text-3xl font-bold">Amenities & Features</h3>
                        </div>
                    ...
                    <div class="mb-12">
                        <div class="flex items-center mb-6">
                            ...
                            <h3 class="text-2xl md:text-3xl font-bold">Suitable For</h3>
                        </div>
                        <div class="flex flex-wrap gap-3">
                            @foreach($hall->event_types as $type)
