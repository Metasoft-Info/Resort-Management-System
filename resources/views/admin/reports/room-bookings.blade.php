...
<div class="p-6">
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">সকল রুম বুকিং এর বিস্তারিত রিপোর্ট</p>
    </div>
        ...
        <form method="GET" action="{{ route('admin.reports.room-bookings') }}">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end">
                    <button type="submit" class="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-3 rounded-lg hover:from-blue-700 hover:to-blue-800 transition shadow-lg">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <div class="p-6 border-b bg-gradient-to-r from-blue-50 to-indigo-50 flex justify-between items-center">
        ...
        <table class="min-w-full">
            <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-sm font-bold text-gray-700">রুম</th>
                    <th class="px-6 py-4 text-left text-sm font-bold text-gray-700">চেক-ইন</th>
                    <th class="px-6 py-4 text-left text-sm font-bold text-gray-700">চেক-আউট</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 text-gray-700">{{ $booking->room->room_number ?? 'N/A' }}</td>
                    <td class="px-6 py-4 text-gray-600">{{ $booking->check_in_date }}</td>
                    <td class="px-6 py-4 text-gray-600">{{ $booking->check_out_date }}</td>
