...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-600 via-accent-600 to-primary-600 relative overflow-hidden">
 ...
 <p class="text-gray-700 font-semibold mb-1">Admin Dashboard Login</p>
 ...
 <i class="fas fa-envelope mr-2 text-primary-600"></i>Email / Email
 </label>
 <input 
 type="email" 
 name="email" 
 ...
 <i class="fas fa-lock mr-2 text-primary-600"></i>Password / Password
 </label>
 <input 
 type="password" 
 name="password" 
