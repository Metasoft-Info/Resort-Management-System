...
<div class="p-6">
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('admin.food-packages.create') }}" class="bg-gradient-to-r from-primary-600 to-primary-700 text-white px-6 py-3 rounded-lg hover:from-primary-700 hover:to-primary-800 transition shadow-lg"><i class="fas fa-plus mr-2"></i>নতুন প্যাকেজ</a>
    </div>
