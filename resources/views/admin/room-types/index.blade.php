        ...
        <table class="min-w-full">
            <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-sm font-bold text-gray-700">সর্বোচ্চ অকুপেন্সি</th>
                    <th class="px-6 py-4 text-left text-sm font-bold text-gray-700">রুম সংখ্যা</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                        ...
                        <p>কোনো রুম টাইপ পাওয়া যায়নি</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
