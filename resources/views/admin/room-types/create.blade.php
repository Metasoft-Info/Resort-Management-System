...
<div class="p-6">
 <div class="mb-8">
 <h1 class="text-3xl font-bold text-gray-800">Add New Room Type</h1>
 <p class="text-gray-600 mt-2">Enter new Room Type information</p>
 </div>
 ...
 <input type="number" name="max_occupancy" value="{{ old('max_occupancy') }}" required
 class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
 ...
 class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">{{ old('description') }}</textarea>
