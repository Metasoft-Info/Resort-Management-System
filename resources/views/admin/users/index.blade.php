...
<div class="p-6">
    <div class="flex justify-between items-center mb-8">
        ...
        <a href="{{ route('admin.users.create') }}" class="bg-gradient-to-r from-indigo-600 to-indigo-700 text-white px-6 py-3 rounded-lg hover:from-indigo-700 hover:to-indigo-800 transition shadow-lg"><i class="fas fa-plus mr-2"></i>নতুন ইউজার</a>
    </div>
        ...
        <table class="min-w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4"><span class="px-3 py-1 rounded-full text-xs font-semibold bg-indigo-100 text-indigo-800">{{ $user->role ?? 'admin' }}</span></td>
