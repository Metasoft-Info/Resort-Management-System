...
<div class="p-6">
 <div class="mb-8">
 <h1 class="text-3xl font-bold text-gray-800">New User</h1>
 <p class="text-gray-600 mt-2">Create New User and set permissions</p>
 </div>
 ...
 <p class="text-gray-600 mb-4">Select which menus this user can access।</p>
 
 @php $groupedMenus = $menuSettings->groupBy('group_name'); @endphp
