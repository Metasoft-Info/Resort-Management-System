...
<div class="p-6">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800">নতুন ব্যবহারকারী</h1>
        <p class="text-gray-600 mt-2">নতুন ব্যবহারকারী তৈরি করুন এবং অনুমতি দিন</p>
    </div>
    <div class="bg-white rounded-xl shadow-lg p-8">
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div id="permissionsSection" class="border-t pt-6 hidden">
                ...
                <p class="text-gray-600 mb-4">এই ব্যবহারকারী কোন মেনু গুলোতে অ্যাক্সেস পাবে নির্বাচন করুন।</p>
