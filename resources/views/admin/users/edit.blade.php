...
<div class="p-6">
 <div class="mb-8">
 <h1 class="text-3xl font-bold text-gray-800">Users Edit</h1>
 <p class="text-gray-600 mt-2">Users Information No </p>
 </div>
 ...
 <div>
 <label class="block text-sm font-semibold text-gray-700 mb-2">Password (leave empty to keep current)</label>
 ...
 <span class="font-semibold text-gray-700">Account Active</span>
 </label>
 <p class="text-sm text-gray-500 mt-1">Inactive accounts cannot login</p>
 </div>
 </div>
 ...
 <i class="fas fa-key text-yellow-500 mr-3"></i>Menu Permissions
 </h3>
 <p class="text-gray-600 mb-4">Select which menus this user can access। (Super Admin/Admin have access to all menus)</p>
 ...
 <i class="fas fa-check-double mr-1"></i>All Select
 </button>
