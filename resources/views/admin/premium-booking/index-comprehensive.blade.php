...
document.getElementById('searchRoomsForm').addEventListener('submit', async function(e) {
 ...
 console.error('Search error:', error);
 showGlobalModal('error', 'Failed to search rooms!');
 }
});
...
async function submitBooking(e) {
 ...
 showGlobalModal('error', 'Error: ' + (data.message || 'Booking failed!'));
...
function resetAll() {
 showConfirmModal('Do you want to reset all fields?', function() {
 location.reload();
 });
}
