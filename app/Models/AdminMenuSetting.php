...
class AdminMenuSetting extends Model
{
    ...
    public static function seedDefaultMenus()
    {
        $menus = [
            ...
            ['menu_key' => 'addon_services', 'menu_label' => 'Addon Services (Convention)', 'menu_icon' => 'fas fa-plus-circle', 'route_name' => 'admin.addon-services.index', 'route_pattern' => 'admin.addon-services.*', 'group_name' => 'Services', 'order' => 40, 'is_system' => false],
            ['menu_key' => 'food_packages', 'menu_label' => 'Food Packages (Convention)', 'menu_icon' => 'fas fa-utensils', 'route_name' => 'admin.food-packages.index', 'route_pattern' => 'admin.food-packages.*', 'group_name' => 'Services', 'order' => 41, 'is_system' => false],
            ['menu_key' => 'extra_charge_categories', 'menu_label' => 'Extra Charges (Resort)', 'menu_icon' => 'fas fa-tags', 'route_name' => 'admin.extra-charge-categories.index', 'route_pattern' => 'admin.extra-charge-categories.*', 'group_name' => 'Services', 'order' => 42, 'is_system' => false],
            ...
            ['menu_key' => 'room_reports', 'menu_label' => 'Room Bookings Report', 'menu_icon' => 'fas fa-file-alt', 'route_name' => 'admin.reports.room-bookings', 'route_pattern' => 'admin.reports.room-bookings', 'group_name' => 'Room Reports', 'order' => 60, 'is_system' => false],
            ['menu_key' => 'advance_reports', 'menu_label' => 'Advance Booking Report', 'menu_icon' => 'fas fa-calendar-check', 'route_name' => 'admin.reports.advance-bookings', 'route_pattern' => 'admin.reports.advance-bookings', 'group_name' => 'Room Reports', 'order' => 61, 'is_system' => false],
